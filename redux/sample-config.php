<?php
    ...
    if ( ! class_exists( 'fm_Redux_Framework_sample_config' ) ) {

        class fm_Redux_Framework_sample_config {
            ...
            public function setArguments() { 
                ...
                $this->args = array(
                    ...
                    'menu_title'           =>'Sample Optionsplugin',
                    'page_title'           => 'Sample Optionsplugin',
        ...
        global $reduxConfig;
        $reduxConfig = new fm_Redux_Framework_sample_config();
    } else {
